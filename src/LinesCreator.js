...
export default class LinesCreator{
    ...
    static createLines(REEL_WIDTH,REEL_HEIGHT, LEFT_EDGE, RIGHT_EDGE,LINES_RECT,SPACE_BETWEEN_REELS){ //SET LOG POINTS
        ...
        for(let i= 1; i < 4; i++){
            ...
            straithLines[i-1].setLogicPoints([[{reel: 1, reelPart: i}],
                                             [{reel: 2, reelPart: i}],
                                             [{reel: 3, reelPart: i}],
                                             [{reel: 4, reelPart: i}],
                                             [{reel: 5, reelPart: i}]
        ...
        vLines[0].setLogicPoints([  {reel: 1, reelPart: 1},
                                    {reel: 2, reelPart: 2},
                                    {reel: 3, reelPart: 3},
                                    {reel: 4, reelPart: 2},
                                    {reel: 5, reelPart: 1}
        ...
        vLines[1].setLogicPoints([  {reel: 1, reelPart: 3},
                                    {reel: 2, reelPart: 2},
                                    {reel: 3, reelPart: 1},
                                    {reel: 4, reelPart: 2},
                                    {reel: 5, reelPart: 3}
        ...
        longVLines[0].setLogicPoints([  {reel: 1, reelPart: 2},
                                        {reel: 2, reelPart: 3},
                                        {reel: 3, reelPart: 3},
                                        {reel: 4, reelPart: 3},
                                        {reel: 5, reelPart: 2}
        ...
        longVLines[1].setLogicPoints([  {reel: 1, reelPart: 2},
                                        {reel: 2, reelPart: 1},
                                        {reel: 3, reelPart: 1},
                                        {reel: 4, reelPart: 1},
                                        {reel: 5, reelPart: 2}
        ...
        zLines[0].setLogicPoints([  {reel: 1, reelPart: 3},
                                    {reel: 2, reelPart: 3},
                                    {reel: 3, reelPart: 2},
                                    {reel: 4, reelPart: 1},
                                    {reel: 5, reelPart: 1}
        ...
        zLines[1].setLogicPoints([  {reel: 1, reelPart: 1},
                                    {reel: 2, reelPart: 1},
                                    {reel: 3, reelPart: 2},
                                    {reel: 4, reelPart: 3},
                                    {reel: 5, reelPart: 3}
